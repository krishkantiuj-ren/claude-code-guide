...
- options:
  ...
  2. label: "不需要", description: "本次对话保持安静，随时输入 /agent-guide 可重新召唤"
  3. label: "保驾护航", description: "平时安静，检测到任务关键词时自动出现"
  4. label: "永久关闭", description: "今后不再自动出现，删除 agent-guide.md 可恢复"
- multiSelect: false
...
详细的向导行为规则请参考 `~/.claude/skills/agent-guide.md` 技能文件。
